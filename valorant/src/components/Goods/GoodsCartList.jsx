...
const GoodsCartList = () => {
  ...
  if (localCarts) {
    cartsArray = JSON.parse(localCarts);
  } else {
    cartsArray = [];
  }
      ...
      <section className="cart-bot">
        <div className="section-wrap">
          ...
          <div className="cart-list">
            {cartsArray.map((item) => (
              <GoodsCartItem key={item.id} item={item} />
            ))}
          </div>
          <div className="cart-order">
            ...
            <div className="btn-container">
              <button onClick={error} className="order-btn">
                ORDER
              </button>
              <button onClick={onGo} className="back-btn">
                BACK
              </button>
            </div>
